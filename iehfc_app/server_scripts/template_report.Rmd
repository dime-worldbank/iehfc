...
```{r enumerator-plot, echo=FALSE, results='asis', eval=params$includeEnumerator, eval=FALSE, include=FALSE}
if (!is.null(params$enumeratorPlotPath) && file.exists(params$enumeratorPlotPath)) {
  # Include the plot
  knitr::include_graphics(params$enumeratorPlotPath)
} else {
  cat("No plot available for enumerator data.")
}
```
