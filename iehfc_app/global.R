...
# Purpose — Load packages and set parameters
  ...
  pacman::p_load(shiny, dplyr, tidyr, purrr, ggplot2, janitor, data.table, DT, remotes, bsicons, shinydashboard, shinyjs)
  
  remotes::install_github(repo = "rstudio/bslib", quiet = TRUE)
