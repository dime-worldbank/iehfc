                            ...
                            fluidRow(
                                ...
                                column(width = 6,
                                       ...
                                       box(width = "100%", status = "success",
                                           ...
                                           img(src = "workflow_diagram.png", style = "max-width:100%;")
                                       ),
                                       ...
                                       box(width = "100%", status = "success",
                                           ...
                                           img(src = "www/WB_logo.png", style = "max-width:100%;")
                                       )
                                )
                            ),
                            fluidRow(
                                ...
                                column(width = 6,
                                       div(style = "text-align:left", tags$h3("Getting Started with iehfc")),
                                       box(width = "100%", status = "success",
